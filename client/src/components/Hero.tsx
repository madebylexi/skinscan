      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-primary-foreground/10 px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-sm font-medium">FDA Allergen Database</span>
          </div>
          ...
          <p className="text-lg sm:text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Instantly scan product websites to identify allergens in ingredient lists. 
            Stay safe with accurate, AI-driven analysis.
          </p>
